...
def test_vienna_api_regression(cases_dir, expected_results_path):
    ...
    for case_dir in case_dirs:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            result = process_sequence(sequence_file, Path(tmpdir), 
                                    generate_html=False, generate_markdown=False)
    ...
    if expected_results_path.exists():
        ...
        pytest.skip(f"Created baseline results at {expected_results_path}. "
