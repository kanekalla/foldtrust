...
from foldtrust.vienna import ViennaRNAError, fold_with_params

# SARS-CoV-2 FSE sequence (slippery site 13462-13468 through stem-loop 2)
FSE_SEQUENCE = (
    "UUUAAACGGGUUUGCGGUGUAAGUGCAGCCCGUCUUACACCGUGCGGCACAGGCACUAGUACUGAUG" "UCGUAUACAGGGCU"
)
...
def test_parameter_sets_differ():
    ...
    assert (
        abs(mfe_andronescu - (-22.26)) < 0.1
    ), f"Andronescu2007: expected -22.26, got {mfe_andronescu:.2f}"
