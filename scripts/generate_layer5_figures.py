...
def plot_temperature_retention(
    ...
    ax.set_title('Stem Retention Across Temperatures\n(vs 37°C Turner2004 baseline)', fontsize=14, fontweight='bold')
...
def plot_params_retention(
    ...
    ax.set_ylabel('Case - Tier', fontsize=12)
    ax.set_title('Stem Retention Across Parameter Sets\n(vs Turner2004 baseline, 37°C)', fontsize=14, fontweight='bold')
...
def plot_window_retention(
    ...
    ax.set_title('Effect of Window Context on Stem Retention\n(Turner2004, 37°C)', fontsize=14, fontweight='bold')
...
if __name__ == "__main__":
    generate_all_layer5_figures(
        Path("benchmarks/outputs/layer5"),
        Path("benchmarks/outputs/figures")
    )
