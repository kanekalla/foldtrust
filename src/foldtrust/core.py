...
from foldtrust.utils import compute_gc_content, read_fasta
from foldtrust.vienna import check_viennarna, compute_pair_probabilities, fold_mfe, parse_stems
...
def process_sequence(
    ...
    result = {
        ...
        "stem_counts": {"firm": firm_count, "soft": soft_count, "floppy": floppy_count},
    }
