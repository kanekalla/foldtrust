...
from foldtrust.vienna import fold_mfe
...
def run_reference_benchmark(
    ...
    for i, entry in enumerate(entries):
        ...
        try:
            ...
            metrics_mfe = compute_accuracy_metrics(
                mfe_structure, ref_structure, allow_slip=allow_slip
            )
...
def generate_reference_report(
    df: pd.DataFrame, summary: Dict, output_dir: Path, allow_slip: bool = False
) -> None:
